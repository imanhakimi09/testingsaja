...
public class supplements3 extends AppCompatActivity {
    int quantity = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplements3);
        ...
        ConfirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String meds3 = medicineTextview.getText().toString();
                ...
                dataMap.put("Item", meds3);
                dataMap.put("Item details", order);

                reference.push().setValue(dataMap);
                //reference.child("Apparels").setValue("shirt3");
                Intent intent = new Intent(supplements3.this, paymentpage.class);
                startActivity(intent);
            }
        });

        submitorder3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
