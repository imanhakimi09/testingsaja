...
public class supplements2 extends AppCompatActivity {
    int quantity = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplements2);
        ...
        ConfirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String meds2 = medicineTextview.getText().toString();
